...
#include "mem/cache/prefetch/globals.hh"
#include "mem/cache/prefetch/superstl.hh"

#define N_STAT_UPDATE(a, b, c)
...
struct FullyAssociativeTags {
  ...
  // XXX Only works for ISB usage!
  //static const T INVALID = InvalidTag<T>::INVALID;
  static const T INVALID = static_cast<T>(0xffffffffffffffffULL);
